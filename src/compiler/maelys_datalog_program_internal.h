...
struct maelys_datalog_program {
    ...
    maelys_datalog_internal_prepared_session_t *prepared_inputs;
};
...
maelys_result_t maelys_datalog_validate_program(maelys_datalog_internal_ruleset_t *, const char *,
                                                const maelys_datalog_parse_origin_t *,
                                                maelys_datalog_internal_diagnostic_t *);
maelys_result_t maelys_datalog_validate_parsed_prefix(maelys_datalog_internal_ruleset_t *, const char *,
                                                      const maelys_datalog_parse_origin_t *,
                                                      maelys_datalog_internal_diagnostic_t *);
maelys_result_t maelys_datalog_parse_only(maelys_datalog_internal_ruleset_t *, const char *, size_t,
                                         const char *, unsigned, maelys_datalog_parse_origin_t *,
                                         maelys_datalog_internal_diagnostic_t *);
maelys_result_t maelys_datalog_compute_program_fingerprint(const maelys_datalog_internal_ruleset_t *, char[65]);
...
void maelys_datalog_copy_load_diagnostic(maelys_datalog_public_diagnostic_t *,
                                         const maelys_datalog_internal_diagnostic_t *);
