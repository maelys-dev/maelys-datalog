...
typedef struct {
    ...
    int allow_undeclared_policy_atoms;
...
static maelys_result_t maelys_datalog_policy_load_from_spec(
    ...
    if (rc == MAELYS_OK) {
        const unsigned parse_flags = spec->allow_undeclared_policy_atoms
                                         ? MAELYS_DATALOG_PARSE_ALLOW_UNDECLARED_POLICY_ATOMS
                                         : 0u;
        rc = maelys_datalog_parse_ruleset_ex_with_flags(tmp,
                                                        spec->src,
                                                        spec->src_len,
                                                        label,
                                                        parse_flags,
...
static maelys_result_t load_policy_entry_from_bundle(
    ...
    maelys_datalog_policy_load_spec_t spec = {
        ...
        .allow_undeclared_policy_atoms =
            (flags & MAELYS_DATALOG_MANIFEST_ALLOW_UNDECLARED_POLICY_ATOMS) != 0u,
...
maelys_result_t maelys_datalog_load_policy_inline(
    ...
    maelys_datalog_policy_load_spec_t spec = {
        ...
        .allow_undeclared_policy_atoms = 0,
