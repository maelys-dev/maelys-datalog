...
} maelys_datalog_internal_edb_t;

_Static_assert(offsetof(maelys_datalog_internal_edb_t, runtime_pair_ids_scratch)
                   + sizeof(maelys_datalog_batch_scratch_t) == sizeof(maelys_datalog_internal_edb_t),
