...
typedef struct maelys_datalog_prepared_session maelys_datalog_internal_prepared_session_t;
...
/* Logical runtime inputs use the application's fact/value types directly.
 * Symbols are borrowed text for the call; the session assigns canonical IDs.
 * No variable kind is admitted in an input fact. */
