...
int maelys_datalog_query_whitelist_contains(const maelys_datalog_internal_ruleset_t *, const char *, size_t);
/* Caller validates handle/lifetime/arity; the same permission check serves all backends. */
maelys_result_t maelys_datalog_validate_query_predicate(const maelys_datalog_internal_ruleset_t *,
                                                        const char *, size_t,
