...
if grep -Enr '#[[:space:]]*include[[:space:]]*[<"](src/|common/|include/|\.\./)' \
    include/maelys modules/standard sdk/examples sdk/templates sdk/conformance src/runtime/maelys_datalog_window.c src/runtime/maelys_datalog_group_window.c; then
