...
#define MAELYS_DATALOG_VERSION_STRING "0.3.1"
#define MAELYS_DATALOG_VERSION_MAJOR 0
#define MAELYS_DATALOG_VERSION_MINOR 3
#define MAELYS_DATALOG_VERSION_PATCH 1
#define MAELYS_DATALOG_VERSION_PRERELEASE ""
