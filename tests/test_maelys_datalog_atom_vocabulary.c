...
static maelys_result_t init_base_ruleset(maelys_datalog_internal_ruleset_t *ruleset,
...
static maelys_result_t init_policy_fact_ruleset(maelys_datalog_internal_ruleset_t *ruleset,
                                                int add_alice_atom) {
...
static maelys_result_t init_runtime_ruleset(maelys_datalog_internal_ruleset_t *ruleset,
                                            int add_alice_atom) {
...
static maelys_result_t parse_source(maelys_datalog_internal_ruleset_t *ruleset,
                                    const char *source,
