...
int main(void) {
    ...
    maelys_datalog_copy_solve_diagnostic(&detail,&compact,r,&r->symbols,MAELYS_ERR_PAYLOAD_TOO_LARGE);
    ...
    maelys_datalog_copy_solve_diagnostic(&detail,&compact,r,&r->symbols,MAELYS_ERR_INTERNAL);
