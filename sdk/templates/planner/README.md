...
Implement deterministic selection from the host-provided safe candidates.
Test index bounds, ties, empty inputs and errors. The planner does not replace
the solver algorithm; use a backend for an independent solver.
