...
Implement prepared/result ownership, full materialization and work accounting.
Compare answers against the reference backend. Advertise only implemented and
tested capabilities; explanation hooks must read retained state without re-solving.
