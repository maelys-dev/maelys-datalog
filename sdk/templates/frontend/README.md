...
Implement lowering with the public IR builder and source locations. The host
validator remains mandatory. Add valid syntax, syntax-error and malformed-IR
fixtures before advertising a language.
